...
ss.plot_scores("data/10x_multi_sample/scores.png")
ss.plot_dendrogram(outpath="data/10x_multi_sample/agglomerative_heatmap.png")

navin_prim = phylics.Sample.from_file("data/navin_primary/SegCopy", sample_name="primary")
df = pd.read_csv("data/navin_primary/results.txt", sep="\t", index_col=0).dropna()
ploidy = df['Copy_Number']
...
navin_met = phylics.Sample.from_file("data/navin_metastasis/SegCopy", sample_name="metastasis")
df = pd.read_csv("data/navin_metastasis/results.txt", sep="\t", index_col=0).dropna()
ploidy = df['Copy_Number']
...
ss.plot_dendrogram(outpath="data/navin_met_prim/agglomerative_heatmap.png")