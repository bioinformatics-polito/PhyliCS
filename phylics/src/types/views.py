...
from anndata.compat import ZappyArray


class _SetItemMixin:
    """\
    Class which (when values are being set) lets their parent CnvData view know,
    so it can make a copy of itself.
    This implements copy-on-modify semantics for views of CnvData objects.
    """
...
class _ViewMixin(_SetItemMixin):
    def __init__(
        self,
        *args,
        view_args: Tuple["cnvdata.CnvData", str, Tuple[str, ...]] = None,
        **kwargs,
    ):
