...
# --
setwd(paste('/home/mmontemurro/ginkgo-runs/ginkgo/uploads/', userID, sep=''))
maxPloidy = 6
...
normal2 = normal
#
GC = read.table(paste("/home/mmontemurro/ginkgo-runs/ginkgo/genomes/", genome, "/", pseudoautosomal, "/GC_", bm, sep=""), header=FALSE, sep="\t", as.is=TRUE)
#
bounds = read.table(paste("/home/mmontemurro/ginkgo-runs/ginkgo/genomes/", genome, "/", pseudoautosomal, "/bounds_", bm, sep=""), header=FALSE, sep="\t")
